...
public class AuditoriaAspect {
	...
	@AfterReturning(pointcut="execution(public void br.com.hslife.orcamento.repository.IRepository.save(..)) && args(entity)")
	...
	@Around("execution(public void br.com.hslife.orcamento.repository.IRepository.update(..)) && args(entity)")
	...
	@AfterReturning(pointcut="execution(public void br.com.hslife.orcamento.repository.IRepository.delete(..)) && args(entity)")
